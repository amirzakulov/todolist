...
class Pagination
{
    ...
    public function toHtml()
    {
        ...
        {
            $html .= '<li class="page-item disabled"><span class="page-link bg-light">&laquo; '. $this->previousText .'</span></li>';
        }
        ...
        {
            $html .= '<li class="page-item disabled"><span class="page-link bg-light">'. $this->nextText .' &raquo;</span></li>';
        }
        $html .= '</ul>';
